...
public class FlutterAmapPlugin implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        ...
        if ("show".equals(method)) {
            ...
            manager.mapViewOptions = mapViewOptions;
            ...
            root.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    FlutterAmapPlugin.manager.updateProps(view, FlutterAmapPlugin.manager.mapViewOptions);
            ...
            final AMapView layout = getView(id);
            if(layout != null){
                manager.moveCamera(layout, lat, lng);
            }
            ...
            result.success(true);
        } else if("poiSearch".equals(method)){
            Map<String, Object> args = (Map<String, Object>) call.arguments;
            String keyword = (String) args.get("keyword");
            String id = (String) args.get("id");
            double lat = (double) args.get("lat");
            double lng = (double) args.get("lng");
            manager.poiSearch(lat, lng, getView(id), keyword);
        }else{
